...
urlpatterns = [
    ...
    path('ticket/create/', review.views.TicketCreate.as_view(
...
#
    path('review/create_with_ticket/', review.views.ReviewCreate.as_view(
        template_name = 'review/review_and_ticket_creation.html'), name='review_create'),
    path('review/on_<int:ticket_id>/', review.views.ReviewCreate.as_view(
        template_name = 'review/review_on_existing_ticket.html'), name='review_create'),
